    ...
    public class AccountController : ApiController
    {
        ...
        public IHttpActionResult GetUser()
        {
            try
            {
                ...
                user_stockify user = db.user_stockify.Find(id);
                if (user == null)
                {
                    return Ok(id);
                }
        ...
        Request.CreateErrorResponse((HttpStatusCode)500,
            ...
            user_stockify us = new user_stockify();
            ...
            try
            {
                ...
                us.id =   UserManager.FindByEmail(model.Email).Id;
             
                us.name = model.Name;
                var id=  db.user_stockify.Add(us);
                db.SaveChanges();
